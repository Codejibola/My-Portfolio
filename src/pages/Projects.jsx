  ...
  return (
    <main className="bg-black text-white font-sans scroll-smooth">
        ...
        <SlideInSection direction="left">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-gray-300 text-lg">
              I’m a Nigerian-based developer focused on creating smooth, high-performing user interfaces. With a growing knowledge of backend technologies, I'm working toward becoming a full-stack engineer.life
            </p>
          </div>
        </SlideInSection>
      </section>
      ...
      <footer className="text-center py-6 bg-black border-t border-zinc-800 text-gray-500">
        &copy; {new Date().getFullYear()} Bello Habeebullah. Built with 💙
      </footer>
    </main>
  );
}
