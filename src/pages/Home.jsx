...
export default function Home() {
  return (
    <section className="text-center py-20 px-4">
      <h1 className="text-5xl font-bold text-blue-700 mb-4">Hi, I'm Bello Habeebullah</h1>
      <p className="text-xl text-gray-600 mb-2">Frontend Developer | React Enthusiast</p>
      ...
      <div className="mt-10 flex justify-center">
        <img
          ...
          className="w-[300px] h-[400px] object-cover rounded-lg border-4 border-blue-500 shadow-lg"
        />
      </div>
    </section>
  );
